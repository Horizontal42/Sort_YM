...
Разбираются только русскоязычные треки. На иноязычном треке смысл передаётся музыкой и подачей
вокала, а не разобранными словами, поэтому буквальное чтение текста добавило бы сигнал, которого
слушатель при прослушивании не считывает.
